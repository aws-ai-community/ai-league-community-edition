...
export const PREDEFINED_MAPS: PredefinedMap[] = [
  ...
  },
  {
    ...
    challenges: {
      ...
      "0,6": { type: "c18", question: "Calculate the energy impact of a 225 MW solar project in Chile. Return annual generation (GWh), carbon offset (tons), and homes powered as JSON.", expectedAnswer: "{\"annual_generation_gwh\":492.8,\"carbon_offset_tons\":206976,\"homes_powered\":46933}", gradingStrategy: "json_exact_match" },
      "0,8": { type: "c18", question: "Calculate the energy impact of a 120 MW onshore wind farm in Scotland. Return annual generation (GWh), carbon offset (tons), and homes powered as JSON.", expectedAnswer: "{\"annual_generation_gwh\":367.9,\"carbon_offset_tons\":154518,\"homes_powered\":35038}", gradingStrategy: "json_exact_match" },
      ...
      "8,2": { type: "c4", question: "Using the AWS Registry of Open Data (registry.opendata.aws), look up The Cancer Genome Atlas dataset. TCGA is a collaboration between which two NIH institutes?", expectedAnswer: "National Cancer Institute", gradingStrategy: "contains_match" },
