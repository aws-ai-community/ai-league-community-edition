...
export const TILE_METADATA: Record<TileKey, TileMetadata> = {
  ...
  c40: { key: 'c40', name: 'Red Key', description: 'Collect to unlock Red Door', category: 'Key', points: 50 },
  c41: { key: 'c41', name: 'Green Key', description: 'Collect to unlock Green Door', category: 'Key', points: 50 },
  c42: { key: 'c42', name: 'Grey Key', description: 'Collect to unlock Grey Door', category: 'Key', points: 50 },
  c43: { key: 'c43', name: 'Yellow Key', description: 'Collect to unlock Yellow Door', category: 'Key', points: 50 },
